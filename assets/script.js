  ...
  var translations = {
    en: {
      common: {
        ...
        footerTagline: 'Building companions that inspire people to live meaningfully.'
      },
      nav: {
        home: 'Home',
        product: 'Product',
      ...
      pages: {
        homeTitle: 'EmeraldLife | Your Wellness Companion',
        homeDescription: 'EmeraldLife is a game-like wellness companion that turns fragmented daily signals into one meaningful action, AI reflection, and private encouragement.',
      ...
      home: {
        eyebrow: 'EmeraldLife',
        heroTitle: 'A wellness companion for the future of living.',
        heroLead: 'Built on professionally informed health and wellness knowledge, EmeraldLife goes beyond information. It turns fragmented daily signals into one meaningful Ritual, a supportive AI reflection, and private encouragement from close friends, so caring for yourself feels clear, personal, and worth returning to.',
        heroPrimary: 'Explore the experience',
        heroSecondary: 'Follow our progress',
        ...
        productCopy: 'Most wellness apps fragment daily life into charts, stats, and separate logs. EmeraldLife brings those signals into one calm, game-like experience centered on what you can do next.',
        storyLabel: 'Why EmeraldLife',
        storyTitle: 'People do not stop caring about their health. They stop using products that make caring feel like work.',
        storyFounders: 'Co-founders James and Tommy have been friends since high school. After trying and quitting health apps, they kept seeing the same problem: too many numbers, fragmented tracking, and no sense of companionship along the way.',
        storyInsight: 'Their insight is simple: professionally informed health and wellness knowledge is essential, but knowledge alone does not keep people going. EmeraldLife brings that knowledge into an original AI companion that helps people understand their day, turn insight into action, regain a sense of agency, and feel supported while progress is happening.',
        featuresLabel: 'Features',
        featuresTitle: 'A simple loop designed to feel good along the way.',
        featureRoutineTitle: 'One daily Ritual',
        featureRoutineCopy: 'A calm companion state turns the day into one small action that feels clear and possible.',
        featureNutritionTitle: 'AI Companion',
        featureNutritionCopy: 'Professionally informed health and wellness guidance, delivered in a tone that feels right for check-ins, Rituals, reflection, and thoughtful next steps.',
        featureHabitTitle: 'Friends, not followers',
        featureHabitCopy: 'What’s On keeps Ritual shares, reactions, and encouragement private, close, and low pressure.',
        featureRecoveryTitle: 'Progress without pressure',
        featureRecoveryCopy: 'Profile shows wellness trends and consistency without turning Home into a score-first dashboard.',
        featureReflectionTitle: 'Quiet intelligence',
        featureReflectionCopy: 'Body Energy, Recovery, Readiness, and Happiness quietly shape the companion, Ritual pace, and AI tone.',
        featureInsightTitle: 'Designed across languages',
        featureInsightCopy: 'The launch plan supports ten languages across the app experience and AI companion conversations.',
        ...
        contactTitle: 'Building the next generation of everyday wellness.',
      ...
      privacy: {
        ...
        effective: '<strong>Effective date:</strong> May, 2026',
    ...
    zhHans: {
      common: {
        ...
        footerTagline: '打造陪伴人们认真生活、活得更有意义的伙伴。'
      },
      nav: {
        home: '首页',
        product: '产品',
      ...
      pages: {
        homeTitle: 'EmeraldLife | 你的健康生活伙伴',
        homeDescription: 'EmeraldLife 是一款游戏化健康生活伙伴，把零散的日常状态转化为一个有意义的行动、AI 反思和私密鼓励。',
      ...
      home: {
        eyebrow: 'EmeraldLife',
        heroTitle: '面向未来生活方式的健康伙伴',
        heroLead: 'EmeraldLife 以专业、可信的健康与生活方式知识为基础，但不止于提供知识。它把零散的日常状态整理成一个有意义的 Ritual、一次有温度的 AI 反思，以及来自亲近好友的私密鼓励，让照顾自己变得清晰、个人化，也更值得每天回来。',
        heroPrimary: '了解产品体验',
        heroSecondary: '查看开发进展',
        ...
        productCopy: '大多数健康应用把日常生活拆成图表、数字和彼此分散的记录。EmeraldLife 把这些状态重新组织成一个平静、游戏化的体验，始终聚焦于下一步可以做什么。',
        storyLabel: '我们为什么创办 EmeraldLife',
        storyTitle: '人们不是不再在意健康，而是照顾自己的过程从来没有让人感觉良好。',
        storyFounders: '联合创始人 James 和 Tommy 从高中起就是朋友。尝试并放弃许多健康应用之后，他们反复看到同一个问题：数字太多、记录太分散，而且整个过程中没有陪伴感。',
        storyInsight: '他们的判断很简单：专业、可信的健康与生活方式知识是基础，但知识本身无法让人一直走下去。EmeraldLife 把这些知识融入原创 AI 伙伴，让人更好地理解自己的每一天，把洞察变成行动，重新掌握身心节奏，并在进步发生时始终感到有人陪伴。',
        featuresLabel: '核心功能',
        featuresTitle: '一个让过程本身也值得坚持的简单循环',
        featureRoutineTitle: '每日一个 Ritual',
        featureRoutineCopy: '平静的伙伴状态，把一天转化成一个清晰、可完成的小行动。',
        featureNutritionTitle: 'AI Companion',
        featureNutritionCopy: '把专业的健康与生活方式知识，转化为适合你的打卡、Ritual 引导、反思和有分寸的下一步建议。',
        featureHabitTitle: '好友，而非关注者',
        featureHabitCopy: 'What’s On 让 Ritual 分享、回应和鼓励只发生在亲近好友之间，私密且低压力。',
        featureRecoveryTitle: '没有压力的进步',
        featureRecoveryCopy: 'Profile 呈现健康趋势与坚持情况，但不会把 Home 变成以分数为中心的仪表盘。',
        featureReflectionTitle: '安静工作的智能',
        featureReflectionCopy: 'Body Energy、Recovery、Readiness 和 Happiness 在后台塑造伙伴状态、Ritual 节奏和 AI 语气。',
        featureInsightTitle: '为多语言体验而设计',
        featureInsightCopy: '启动计划覆盖十种语言，包括应用界面与 AI Companion 对话。',
        privacyLabel: '隐私',
      ...
      privacy: {
        title: '隐私政策',
        effective: '<strong>生效日期：</strong>2026 年 5 月',
    ...
    zhHant: {
      common: {
        ...
        footerTagline: '打造陪伴人們認真生活、活得更有意義的夥伴。'
      },
      nav: {
        home: '首頁',
        product: '產品',
      ...
      pages: {
        homeTitle: 'EmeraldLife | 你的健康生活夥伴',
        homeDescription: 'EmeraldLife 是一款遊戲化健康生活夥伴，把零散的日常狀態轉化為一個有意義的行動、AI 反思和私密鼓勵。',
      ...
      home: {
        eyebrow: 'EmeraldLife',
        heroTitle: '面向未來生活方式的健康夥伴',
        heroLead: 'EmeraldLife 以專業、可信的健康與生活方式知識為基礎，但不止於提供知識。它把零散的日常狀態整理成一個有意義的 Ritual、一次有溫度的 AI 反思，以及來自親近好友的私密鼓勵，讓照顧自己變得清晰、個人化，也更值得每天回來。',
        heroPrimary: '了解產品體驗',
        heroSecondary: '查看開發進展',
        ...
        productCopy: '大多數健康應用把日常生活拆成圖表、數字和彼此分散的記錄。EmeraldLife 把這些狀態重新組織成一個平靜、遊戲化的體驗，始終聚焦於下一步可以做什麼。',
        storyLabel: '我們為什麼創辦 EmeraldLife',
        storyTitle: '人們不是不再在意健康，而是照顧自己的過程從來沒有讓人感覺良好。',
        storyFounders: '聯合創辦人 James 和 Tommy 從高中起就是朋友。嘗試並放棄許多健康應用之後，他們反覆看到同一個問題：數字太多、記錄太分散，而且整個過程中沒有陪伴感。',
        storyInsight: '他們的判斷很簡單：專業、可信的健康與生活方式知識是基礎，但知識本身無法讓人一直走下去。EmeraldLife 把這些知識融入原創 AI 夥伴，讓人更好地理解自己的每一天，把洞察變成行動，重新掌握身心節奏，並在進步發生時始終感到有人陪伴。',
        featuresLabel: '核心功能',
        featuresTitle: '一個讓過程本身也值得堅持的簡單循環',
        featureRoutineTitle: '每日一個 Ritual',
        featureRoutineCopy: '平靜的夥伴狀態，把一天轉化成一個清晰、可完成的小行動。',
        featureNutritionTitle: 'AI Companion',
        featureNutritionCopy: '把專業的健康與生活方式知識，轉化為適合你的打卡、Ritual 引導、反思和有分寸的下一步建議。',
        featureHabitTitle: '好友，而非關注者',
        featureHabitCopy: 'What’s On 讓 Ritual 分享、回應和鼓勵只發生在親近好友之間，私密且低壓力。',
        featureRecoveryTitle: '沒有壓力的進步',
        featureRecoveryCopy: 'Profile 呈現健康趨勢與堅持情況，但不會把 Home 變成以分數為中心的儀表板。',
        featureReflectionTitle: '安靜工作的智能',
        featureReflectionCopy: 'Body Energy、Recovery、Readiness 和 Happiness 在背景塑造夥伴狀態、Ritual 節奏和 AI 語氣。',
        featureInsightTitle: '為多語言體驗而設計',
        featureInsightCopy: '啟動計劃涵蓋十種語言，包括應用介面與 AI Companion 對話。',
        privacyLabel: '隱私',
