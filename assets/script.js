  ...
  var translations = {
    en: {
      ...
      home: {
        ...
        storyFounders: 'EmeraldLife’s co-founders have been friends since high school. After trying and quitting health apps, they kept seeing the same problem: too many numbers, fragmented tracking, and no sense of companionship along the way.',
    ...
    zhHans: {
      ...
      home: {
        ...
        storyFounders: 'EmeraldLife 的两位联合创始人从高中起就是朋友。尝试并放弃许多健康应用之后，他们反复看到同一个问题：数字太多、记录太分散，而且整个过程中没有陪伴感。',
    ...
    zhHant: {
      ...
      home: {
        ...
        storyFounders: 'EmeraldLife 的兩位聯合創辦人從高中起就是朋友。嘗試並放棄許多健康應用之後，他們反覆看到同一個問題：數字太多、記錄太分散，而且整個過程中沒有陪伴感。',
