(function () {
  ...
  var translations = {
    ...
    zhHans: {
      ...
      home: {
        eyebrow: 'Emerald Living',
        heroTitle: '专注营养与恢复的平静中枢。',
        heroLead: '使用 Smart Scan 瞬间记录餐食，追踪宏量营养，同步 Apple Health 恢复数据。一切，尽在一个宁静而专注的每日视图。',
        ...
        disclaimerText: 'Emerald Living 旨在提供一般健康与生活方式支持，不提供医疗建议、诊断或治疗。',
        productTitle: '以更从容的方式，支持每日身心健康。',
        productCopy: 'Emerald Living 为日常生活注入秩序、反思与意图。专为渴望以更简单的方式培养健康习惯、关注营养、了解恢复信号并保持生活规律的人而设计。',
        featuresLabel: '核心功能',
        featuresTitle: '源自真实的 App 体验。',
        featureRoutineTitle: 'Today 视图',
        featureRoutineCopy: '在一个专注的每日界面中，回顾饮食、恢复状态、热量与宏量营养。',
        featureNutritionTitle: 'Smart Scan',
        featureNutritionCopy: '通过相机优先的流程记录餐食，让营养状况与每日目标紧密相连。',
        featureHabitTitle: '宏量营养目标',
        featureHabitCopy: '基于个人资料设定目标，让蛋白质、碳水化合物和脂肪的摄入情况一目了然。',
        featureRecoveryTitle: '恢复状态与 HRV',
        featureRecoveryCopy: '结合支持的穿戴设备数据，对比个人基线，查看睡眠、静息心率和 HRV。',
        featureReflectionTitle: '训练负荷',
        featureReflectionCopy: '将日常活动、步数、活动能量和体能训练转化为实用的训练参考。',
        featureInsightTitle: '个人设置',
        featureInsightCopy: '自定义热量估算、宏量营养比例、提醒、单位以及健康数据访问偏好。',
        privacyLabel: '隐私',
        privacyTitle: '以清晰的数据实践为设计核心。',
        privacyCopy: 'Emerald Living 的构建始终注重清晰沟通、用户控制权以及尊重用户的产品设计。',
        privacyLink: '阅读隐私政策',
        healthLabel: '健康免责声明',
        healthTitle: '专注日常健康，而非医疗护理。',
        healthCopy: 'Emerald Living 不是医疗器械，也不用于诊断、治疗、治愈或预防任何疾病。有关健康问题，请始终咨询合格的医疗专业人士。',
        healthLink: '阅读健康免责声明',
        contactLabel: '联系我们',
        contactTitle: 'Emerald Living 目前正在开发中。',
    ...
    zhHant: {
      ...
      home: {
        eyebrow: 'Emerald Living',
        heroTitle: '專注營養與恢復的平靜中樞。',
        heroLead: '使用 Smart Scan 瞬間記錄餐食，追蹤宏量營養，同步 Apple Health 恢復資料。一切，盡在一個寧靜而專注的每日視圖。',
        ...
        disclaimerText: 'Emerald Living 旨在提供一般健康與生活方式支援，不提供醫療建議、診斷或治療。',
        productTitle: '以更從容的方式，支持每日身心健康。',
        productCopy: 'Emerald Living 為日常生活注入秩序、反思與意圖。專為渴望以更簡單的方式培養健康習慣、關注營養、了解恢復信號並保持生活規律的人而設計。',
        featuresLabel: '核心功能',
        featuresTitle: '源自真實的 App 體驗。',
        featureRoutineTitle: 'Today 視圖',
        featureRoutineCopy: '在一個專注的每日介面中，回顧飲食、恢復狀態、熱量與宏量營養。',
        featureNutritionTitle: 'Smart Scan',
        featureNutritionCopy: '透過相機優先的流程記錄餐食，讓營養狀況與每日目標緊密相連。',
        featureHabitTitle: '宏量營養目標',
        featureHabitCopy: '基於個人資料設定目標，讓蛋白質、碳水化合物和脂肪的攝入情況一目了然。',
        featureRecoveryTitle: '恢復狀態與 HRV',
        featureRecoveryCopy: '結合支援的穿戴裝置資料，對比個人基線，查看睡眠、靜息心率和 HRV。',
        featureReflectionTitle: '訓練負荷',
        featureReflectionCopy: '將日常活動、步數、活動能量和體能訓練轉化為實用的訓練參考。',
        featureInsightTitle: '個人設定',
        featureInsightCopy: '自訂熱量估算、宏量營養比例、提醒、單位以及健康資料存取偏好。',
        privacyLabel: '隱私',
        privacyTitle: '以清晰的資料實務為設計核心。',
        privacyCopy: 'Emerald Living 的構建始終注重清晰溝通、用戶控制權以及尊重用戶的產品設計。',
        privacyLink: '閱讀隱私政策',
        healthLabel: '健康免責聲明',
        healthTitle: '專注日常健康，而非醫療護理。',
        healthCopy: 'Emerald Living 不是醫療器械，也不用於診斷、治療、治癒或預防任何疾病。有關健康問題，請始終諮詢合格的醫療專業人士。',
        healthLink: '閱讀健康免責聲明',
        contactLabel: '聯絡我們',
        contactTitle: 'Emerald Living 目前正在開發中。',
