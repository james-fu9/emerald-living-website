  ...
  var translations = {
    en: {
      ...
      home: {
        ...
        heroTitle: 'Build a daily rhythm around food, movement, and progress.',
        heroLead: 'EmeraldLiving brings nutrition, Smart Scan meal logging, Apple Health movement, wearable recovery signals, and progress context into one calm daily view.',
        ...
        visualToday: 'Today',
        visualMorning: 'Morning Routine',
        visualHealth: 'Movement, wearable, and scale signals',
        visualReadiness: 'Readiness',
        visualCalories: 'Food Calories',
        visualMacros: 'Protein, Carbs, Fat',
        visualScan: 'Smart Scan',
        visualFitness: 'Fitness Load',
        visualNutrition: 'Nutrition Balance',
        visualHydration: 'Hydration',
        visualSleep: 'Sleep Reflection',
        visualRecovery: 'Sleep, HRV, resting HR',
        visualCheckIn: 'Daily Check-in',
    ...
    zhHans: {
      ...
      home: {
        eyebrow: '翡翠生活',
        heroTitle: '围绕饮食、运动和进展建立每日节奏。',
        heroLead: 'EmeraldLiving 将营养、Smart Scan 餐食记录、Apple Health 运动、穿戴恢复信号和进展语境放进一个平静的每日视图。',
        ...
        visualToday: '今天',
        visualMorning: '晨间习惯',
        visualHealth: '运动、穿戴和体重秤信号',
        visualReadiness: '恢复状态',
        visualCalories: '食物热量',
        visualMacros: '蛋白质、碳水、脂肪',
        visualScan: 'Smart Scan',
        visualFitness: '训练负荷',
        visualNutrition: '营养平衡',
        visualHydration: '饮水',
        visualSleep: '睡眠回顾',
    ...
    zhHant: {
      ...
      home: {
        eyebrow: '翡翠生活',
        heroTitle: '圍繞飲食、運動和進展建立每日節奏。',
        heroLead: 'EmeraldLiving 將營養、Smart Scan 餐食記錄、Apple Health 運動、穿戴恢復信號和進展語境放進一個平靜的每日視圖。',
        ...
        visualToday: '今天',
        visualMorning: '晨間習慣',
        visualHealth: '運動、穿戴和體重秤信號',
        visualReadiness: '恢復狀態',
        visualCalories: '食物熱量',
        visualMacros: '蛋白質、碳水、脂肪',
        visualScan: 'Smart Scan',
        visualFitness: '訓練負荷',
        visualNutrition: '營養平衡',
        visualHydration: '飲水',
        visualSleep: '睡眠回顧',
