  ...
  var translations = {
    ...
    zhHans: {
      ...
      home: {
        ...
        privacyCopy: 'Emerald Living 注重清晰沟通、用户掌控与尊重隐私的产品设计。',
        privacyLink: '阅读隐私政策',
        healthLabel: '健康声明',
        healthTitle: '健康支持，非医疗用途',
        healthCopy: 'Emerald Living 不是医疗器械，不用于诊断、治疗、治愈或预防疾病。健康问题请咨询专业医疗人员。',
        healthLink: '阅读健康声明',
        contactLabel: '联系我们',
        contactTitle: 'Emerald Living 仍在开发中',
    ...
    zhHant: {
      ...
      home: {
        ...
        privacyCopy: 'Emerald Living 注重清晰溝通、用戶掌控與尊重隱私的產品設計。',
        privacyLink: '閱讀隱私政策',
        healthLabel: '健康聲明',
        healthTitle: '健康支援，非醫療用途',
        healthCopy: 'Emerald Living 不是醫療器械，不用於診斷、治療、治癒或預防疾病。健康問題請諮詢專業醫療人員。',
        healthLink: '閱讀健康聲明',
        contactLabel: '聯絡我們',
        contactTitle: 'Emerald Living 仍在開發中',
