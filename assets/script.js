  ...
  var translations = {
    en: {
      ...
      home: {
        ...
        heroLead: 'EmeraldLife turns fragmented daily signals into one meaningful Ritual, a supportive AI reflection, and private encouragement from close friends. Caring for yourself can feel clear, personal, and worth returning to.',
        ...
        storyInsight: 'Their insight is simple: expertise alone is not enough. EmeraldLife is being built as an original AI companion that helps people visualize daily life, regain a sense of agency, and make progress feel good while it is happening.',
        ...
        featureNutritionCopy: 'Choose a tone that feels right for check-ins, Ritual guidance, reflection, and thoughtful next steps.',
    ...
    zhHans: {
      ...
      home: {
        ...
        heroLead: 'EmeraldLife 把零散的日常状态整理成一个有意义的 Ritual、一次支持性的 AI 反思，以及来自亲近好友的私密鼓励。让照顾自己变得清晰、个人化，也更值得每天回来。',
        heroPrimary: '了解产品体验',
        ...
        storyInsight: '他们的判断很简单：专业知识本身还不够，陪伴同样重要。EmeraldLife 正在打造原创的 AI 伙伴体验，帮助人们看见自己的日常生活，重新掌握身心节奏，并让进步发生的过程本身也感觉良好。',
        featuresLabel: '核心功能',
        featuresTitle: '一个让过程本身也值得坚持的简单循环',
        featureRoutineTitle: '每日一个 Ritual',
        featureRoutineCopy: '平静的伙伴状态，把一天转化成一个清晰、可完成的小行动。',
        featureNutritionTitle: 'AI Companion',
        featureNutritionCopy: '选择适合自己的陪伴语气，用于打卡、Ritual 引导、反思和有分寸的下一步建议。',
    ...
    zhHant: {
      ...
      home: {
        ...
        heroLead: 'EmeraldLife 把零散的日常狀態整理成一個有意義的 Ritual、一次支持性的 AI 反思，以及來自親近好友的私密鼓勵。讓照顧自己變得清晰、個人化，也更值得每天回來。',
        heroPrimary: '了解產品體驗',
        ...
        storyInsight: '他們的判斷很簡單：專業知識本身還不夠，陪伴同樣重要。EmeraldLife 正在打造原創的 AI 夥伴體驗，幫助人們看見自己的日常生活，重新掌握身心節奏，並讓進步發生的過程本身也感覺良好。',
        featuresLabel: '核心功能',
        featuresTitle: '一個讓過程本身也值得堅持的簡單循環',
        featureRoutineTitle: '每日一個 Ritual',
        featureRoutineCopy: '平靜的夥伴狀態，把一天轉化成一個清晰、可完成的小行動。',
        featureNutritionTitle: 'AI Companion',
        featureNutritionCopy: '選擇適合自己的陪伴語氣，用於打卡、Ritual 引導、反思和有分寸的下一步建議。',
